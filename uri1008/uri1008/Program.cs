...
Entrada
O arquivo de entrada contém 2 números inteiros e 1 número com duas casas decimais, representando o número, quantidade de horas trabalhadas e
...
class URI
{
    ...
    static void Main(string[] args)
    {
        ...
        honorarios = Convert.ToDouble(Console.ReadLine());

        Console.WriteLine("NUMBER = " + numFuncionario);
        Console.WriteLine("SALARY = U$ " + (numHoras * honorarios).ToString("F2", CultureInfo.InvariantCulture));
    }
