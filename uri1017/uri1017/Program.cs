...
Para efetuar o cálculo, deve-se fornecer o tempo gasto na viagem (em horas) e a velocidade média durante a mesma (em km/h). Assim, pode-se obter distância percorrida e,
...
class URI
{
    ...
    {
        int horas_viagem = int.Parse(Console.ReadLine());
        int velocidade_media = int.Parse(Console.ReadLine());

        double distancia_percorrida = velocidade_media * horas_viagem;
        double litros = distancia_percorrida / 12;
